...
},{"./groups":1}],3:[function(require,module,exports){
/*!
...
$(document).on('change', '#base-currency', function () {
	getRates($('#base-currency').val());
});
